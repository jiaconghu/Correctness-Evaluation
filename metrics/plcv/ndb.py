...
class NDB:
    ...
    def construct_bins(self, training_samples, bins_file):
        ...
        print('Performing K-Means clustering of {} samples in dimension {} / {} to {} clusters ...'.format(n, d_used, d,
                                                                                                           k))
...
if __name__ == "__main__":
    ...
    test_samples = np.random.uniform(high=0.0, size=[n_test, dim])
    ndb.evaluate(test_samples, model_label='Test')
